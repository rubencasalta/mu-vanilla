...
class Extended_CPT {
	...
	public function __construct( string $post_type, array $args = [], array $names = [] ) {
		...
		$this->defaults['labels'] = [
			...
			'edit_item'                => sprintf( __('Editar', 'mu-domain') ),
			'new_item'                 => sprintf( __('Nuevo', 'mu-domain') ),
			'view_item'                => sprintf( __('Ver', 'mu-domain') ),
			'view_items'               => sprintf( __('Ver', 'mu-domain') ),
			'search_items'             => sprintf( __('Buscar', 'mu-domain') ),
			'not_found'                => sprintf( __('Sin %s.', 'mu-domain'), $this->post_plural_low ),
			'not_found_in_trash'       => sprintf( __('Sin %s.', 'mu-domain'), $this->post_plural_low ),
			'parent_item_colon'        => sprintf( __('Padre de %s:', 'mu-domain'), $this->post_singular ),
			'all_items'                => sprintf( __('Todos', 'mu-domain') ),
			'archives'                 => sprintf( __('Archivos', 'mu-domain') ),
			'attributes'               => sprintf( __('Atributos', 'mu-domain') ),
			'insert_into_item'         => sprintf( __('Insertado', 'mu-domain') ),
			'uploaded_to_this_item'    => sprintf( __('Subido', 'mu-domain') ),
			'filter_items_list'        => sprintf( __('Filtrar %s', 'mu-domain'), $this->post_plural_low ),
			'items_list_navigation'    => sprintf( __('Navegación', 'mu-domain') ),
			'items_list'               => sprintf( __('Listados', 'mu-domain') ),
			'item_published'           => sprintf( __('Publicado.', 'mu-domain') ),
			'item_published_privately' => sprintf( __('Publicado de forma privada.', 'mu-domain') ),
			'item_reverted_to_draft'   => sprintf( __('Volver a borrador.', 'mu-domain') ),
			'item_scheduled'           => sprintf( __('Programado.', 'mu-domain') ),
			'item_updated'             => sprintf( __('Actualizado.', 'mu-domain') ),
		];
		...
		if ( isset( $args['featured_image'] ) ) {
			...
			$this->defaults['labels']['set_featured_image']    = sprintf( __('Poner', 'mu-domain') );
			$this->defaults['labels']['remove_featured_image'] = sprintf( __('Sacar', 'mu-domain') );
			$this->defaults['labels']['use_featured_image']    = sprintf( __('Utilizar', 'mu-domain') );
		}
